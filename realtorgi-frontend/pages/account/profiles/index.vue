  ...
  <div class="new-profile">
    <div class="new-profile-wrapper">
      <div class="new-profile-header">
        ...
        <div class="subtitle">
          Юридическая форма собственности, от лица которой совершаются действия
        </div>
        <div class="choose-profile" v-if="this.$store.state.auth.userData.profile.type_user === 'jur' || this.$store.state.auth.userData.profile.type_user === 'ip' || this.$store.state.auth.userData.profile.type_user === 'phys'">
          <label>Форма собственности:</label>
          <div class="profile-types">
            <div v-if="this.$store.state.auth.userData.profile.type_user === 'jur'" class="button active">Юридическое лицо</div>
            <div v-else-if="this.$store.state.auth.userData.profile.type_user === 'ip'" class="button active">Индивидуальный предприниматель</div>
            <div v-else-if="this.$store.state.auth.userData.profile.type_user === 'phys'" class="button active">Физическое лицо</div>
          </div>
        </div>
      </div>
      <div class="new-profile-counterparty">
        ...
        <individual-enterpreneur-form v-else-if="this.$store.state.auth.userData.profile.type_user === 'ip'" ref="individualEnterpreneurForm" />
      ...
      <div class="button">
        <nuxt-link :to="{ name: 'account-profiles-new' }">
            <button v-if="this.$store.state.auth.userData.profile.type_user === 'jur' || this.$store.state.auth.userData.profile.type_user === 'ip' || this.$store.state.auth.userData.profile.type_user === 'phys'" class="new-profile-submit" @click="addProfile">Изменить профиль</button>
