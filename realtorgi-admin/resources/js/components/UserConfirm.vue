<template>
    <section class="content">
        <div class="container-fluid">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover">
                                ...
                                <tr v-for="us in users.data" :key="us.id">
                                    ...
                                    <td>{{ us.id }}</td>
                                    <td v-if="us.user.type != '' && us.user.type != null" class="text-capitalize">
                                        {{ us.user.type }}
                                    </td>
                                    ...
                                    <td v-if="us.type_user == '' || us.type_user == null" class="text-capitalize">Не
                                        указан
                                    </td>
            ...
            <div class="modal fade" id="user_comment" tabindex="-1" role="dialog" aria-labelledby="user_comment"
                 aria-hidden="true">
                        ...
                        <form @submit.prevent="editmode ? updateUser() : createUser()">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select v-on:change="changeType" name="type_user" v-model="form.type_user"
                                            id="type_user" class="form-control"
                                ...
                                <div id="phys" class="user_info_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.passport_number" type="text" name="passport_number"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('passport_number') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.passport_issuer" type="text" name="passport_issuer"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('passport_issuer') }">
                                        <has-error :form="form" field="passport_issuer"></has-error>
                                    </div>

                                    <div class="form-group">
                                        <label>Дата выдачи паспорта</label>
                                        <input type="text" v-model="form.passportDate" name="passportDate"
                                               :formatter="getDate(form.passportDate)"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('passportDate') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.passport_personal" type="text" name="passport_personal"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('passport_personal') }">
                                        <has-error :form="form" field="passport_personal"></has-error>
                                    </div>

                                    <div class="form-group">
                                        <label>Адрес прописки</label>
                                        <input v-model="form.registration_address" type="text"
                                               name="registration_address"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('registration_address') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.residence_address" type="text" name="residence_address"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('residence_address') }">
                                ...
                                <div id="jur" class="user_info_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="form.egr_date" name="egr_date"
                                               :formatter="getDate(form.egr_date)"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('egr_date') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.manager_data" type="text" name="manager_data"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('manager_data') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.place_of_residence" type="text" name="place_of_residence"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('place_of_residence') }">
                                        <has-error :form="form" field="place_of_residence"></has-error>
                                    </div>

                                    <div class="form-group">
                                        <label>Почтовый адрес (Почтовый индекс, город, улица, дом), если не совпадает с
                                            юридическим адресом</label>
                                        <input v-model="form.registration_address" type="text"
                                               name="registration_address"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('registration_address') }">
                                    ...
                                    <div class="form-group">
                                        <label>Банковские реквизиты: банк, код банка (bic), УНП банка, р/счёт
                                            (iban)</label>
                                        <input v-model="form.bank_details" type="text" name="bank_details"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('bank_details') }">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.legal_entity" type="text" name="legal_entity"
                                               class="form-control"
                                               :class="{ 'is-invalid': form.errors.has('legal_entity') }">
