    ...
    export default {
        ...
        methods: {
            ...
            sendComment(){
                ...
                this.form.put('/admin/api/change_user/'+this.form.id)
                .then((response) => {
                    // success
            ...
            getResults(page = 1) {
                  ...
                  axios.get('/admin/api/change_user?page=' + page).then(({ data }) => (this.users = data.data));
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                        ...
                        // Send request to the server
                         if (result.value) {
                            this.form.delete('/admin/api/change_user/'+id).then(()=>{
                                    Swal.fire(
                                    'Deleted!',
          ...
          loadUsers(){
            ...
            if(this.$gate.isAdmin()){
              axios.get("/admin/api/change_user").then(({ data }) => (this.users = data.data));
            }
