                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <tr :id="feedback.id" v-for="feedback in feedbacks.data" :key="feedback.id"
                                    :class="{ 'not-viewed' : feedback.status === 'new'}">
                                    <td>{{ feedback.id }}</td>
                                    <td>{{ feedback.name }}</td>
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            ...
            axios.get('/admin/api/admin/feedback?page=' + page).then(({data}) => (this.feedbacks = data.data));
        ...
        loadNotifications() {
            ...
            axios.get("/admin/api/admin/feedback").then(({data}) => (this.feedbacks = data.data));
            // }
        },
        ...
        editModal(feedback) {
            ...
            this.$Progress.start();
            this.form.put('/admin/api/admin/feedback/' + this.form.id)
        ...
        deleteNotification(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.form.delete('/admin/api/admin/feedback/' + id).then(() => {
                        Swal.fire(
                            'Deleted!',
