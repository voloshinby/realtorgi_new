      ...
      components: {
        ...
        methods: {
          ...
          getResults(page = 1) {
              ...
              axios.get('/admin/api/admin/lot_item/'+this.$route.params.id+'?page=' + page).then(({ data }) => (this.items = data.data));

              this.$Progress.finish();
          },
          loadItems(){
            // if(this.$gate.isAdmin()){
              axios.get("/admin/api/admin/lot_item/"+this.$route.params.id).then(({ data }) => (this.items = data.data));
            // }
          },
          ...
          createItem(){
              ...
              this.form.post('/admin/api/admin/lot_item')
              .then((data)=>{
                if(data.data.success){
                  ...
                  Toast.fire({
                    ...
                    if (typeof this.files !== 'undefined') {
                        ...
                        axios.post( '/admin/api/admin/item/uploadImages/'+data.data.data.id,
                        formData,
                        {
                            headers: {
          ...
          updateItem(){
              ...
              this.form.put('/admin/api/admin/lot_item/'+this.form.id)
              .then((response) => {
                  ...
                  Toast.fire({
                    ...
                    if (typeof this.files !== 'undefined') {
                        ...
                        axios.post( '/admin/api/admin/item/uploadImages/'+this.form.id,
                        formData,
                        {
                            headers: {
                                'Content-Type': 'multipart/form-data'
              ...
              Swal.fire({
                  ...
                  confirmButtonText: 'Yes, delete it!'
                      ...
                      // Send request to the server
                        if (result.value) {
                              this.form.delete('/admin/api/admin/lot_item/'+id).then(()=>{
                                      Swal.fire(
                                      'Deleted!',
            ...
            deleteImage(id){
                ...
                if(alertSure){
                    axios.post( '/admin/api/admin/item/destroyImages/'+id,
                        ).then(function(){
                            console.log('SUCCESS!!');
                            $('#image_'+id).remove();
                            this.loadItems();
            ...
            deleteFile(id){
                ...
                if(alertSure){
                    axios.post( '/admin/api/admin/item/destroyFiles/'+id,
                        ).then(function(){
                            console.log('SUCCESS!!');
                            $('#file_'+id).remove();
                            this.loadItems();
