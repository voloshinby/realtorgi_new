...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            ...
            axios.get('/admin/api/notification?page=' + page).then(({data}) => (this.notifications = data.data));
        ...
        loadNotifications() {
            ...
            axios.get("/admin/api/notification").then(({data}) => (this.notifications = data.data));
            // }
        },
        ...
        editModal(notification) {
            ...
            this.$Progress.start();
            this.form.put('/admin/api/notification/' + this.form.id)
            this.$Progress.finish();
        },
        newModal() {
            this.editmode = false;
        ...
        deleteNotification(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.form.delete('/admin/api/notification/' + id).then(() => {
                        Swal.fire(
                            'Deleted!',
