                                ...
                                <div class="tab-pane active show" id="settings">
                                    <form @click.prevent="updateInfo" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input disabled type="" v-model="form.login" class="form-control" id="inputLogin"  :class="{ 'is-invalid': form.errors.has('login') }">
                                                <has-error :form="form" field="email"></has-error>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="inputPhone" class="col-sm-2 control-label">НОМЕР ТЕЛЕФОНА</label>

                                            <div class="col-sm-12">
                                                <input type="" v-model="form.phone" class="form-control" id="inputPhone"  :class="{ 'is-invalid': form.errors.has('phone') }">
                                                <has-error :form="form" field="email"></has-error>
                                            </div>
                                        </div>
    ...
    export default {
        ...
        methods:{
            ...
            updateInfo(){
                ...
                this.form.put('/admin/api/admin/profile')
                .then((data)=>{
            ...
            updatePassword(){
                this.$Progress.start();
                this.form.post('/admin/api/admin/change-password')
                .then((data)=>{
        ...
        created() {
            ...
            axios.get("/admin/api/admin/profile")
